...
# CLASSES = ('JDB_can', 'baishi_black', 'baishi_blue', 'cp_ml', 'cp_nm', 'cp_peach', 'cp_yz', 'dp_bottle', 'dp_can', 'kaishui', 'mozhao_blue', 'mozhao_green', 'mozhao_orange', 'mozhao_pink', 'mozhao_white', 'redbull_bottle', 'redbull_can', 'rio_gp', 'rio_lizhi', 'rio_orange', 'rio_peach', 'rio_sb', 'rusuanjun', 'wanglaoji', 'wangzai', 'watson_black', 'watson_yellow', 'yangledu', 'yingyang_apple', 'yingyang_blue', 'yingyang_boluo', 'yingyang_peach', 'yingyang_purple', 'yingyang_sb', 'yingyang_white', 'yingyang_zao', 'z_OP', 'z_baishi_dragen', 'z_ganlu_amall_right', 'z_ganlu_big_left', 'z_nongfushanquan', 'z_peach_what', 'z_youyiC')
